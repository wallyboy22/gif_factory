            ...
            if create_collage or add_labels:
                if not state.is_complete("overlay_legend"):
                    ...
                    FrameProcessor.render_legend_overlay(
                        ...
                        vmin=viz_params.get("min", 0),
                        vmax=viz_params.get("max", 1),
                        font_size=50,
