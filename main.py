...
def main():
    if len(sys.argv) > 1:
        ...
        print("  python main.py --generate --dataset brasil_fire_col3 --product annual_burned --territory df")
        print()
        print("Dashboard:")
        print("  streamlit run src/ipam_gif_factory/interfaces/dashboard.py")
        print()
        print("API:")
        print("  python src/ipam_gif_factory/interfaces/api.py")
